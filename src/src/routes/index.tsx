...
const CONFIG = {
  ...
  heroSub: "To the most wonderful fiancée and my favorite person in the world",
  marquee: [
    "Happy Birthday",
    "You Are Loved",
    "Forever Yours",
  ...
  letter: `Happy Birthday, My Dearest Sophia ❤️

Today isn't just about celebrating another year — it's a celebration of the day the universe brought someone truly extraordinary into my world. 🥹❤️

To be honest, words will never be quite enough to express just how much you mean to me. Even the smallest curve of your smile can brighten my darkest days, and your laughter is my favorite sound in this entire world. ❤️

Through all our playful banter, our spontaneous late-night talks, and every sweet moment we share, one thing remains certain: you are my peace, my home, and the best decision my heart ever made. 🫶🏻

All I ever want is to see you happy, to stand by your side as you achieve every dream, and to spend a lifetime giving you all the unconditional love you deserve.

Happy Birthday to the girl of my dreams and the love of my life. ❤️

May the year ahead bring you endless joy, bright adventures, and all the happiness this world can hold.

It might be your birthday today, but the greatest gift was given to me the day you walked into my life. 🥹❤️`,
    ...
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <main className="relative z-10">
        ...
        >
          ...
          <div className="relative mt-2 overflow-visible px-4">
            <span className="inline-block font-script glow-soft text-gradient-romance px-10 py-3 text-6xl leading-[1.35] sm:text-8xl select-none overflow-visible">
              {CONFIG.name}
            </span>
          </div>
        ...
        <section id="letter" className="mx-auto max-w-3xl px-6 py-24">
          <SectionTitle script="A Letter For You" sub="A few heartfelt words written just for you..." />
        ...
        <footer className="relative z-10 px-6 pb-16 text-center text-sm text-muted-foreground">
          <p className="font-playfair font-medium tracking-wide text-xl text-primary">Made with infinite love by Liam for Sophia ❤️</p>
