...
const BUTTERFLIES: ButterflyData[] = [
  {
    ...
    message:
      "Sophia, your smile has a gentle magic that instantly brightens my whole world. No matter how exhausting or difficult any day feels, seeing your laugh makes everything peaceful and light. Always keep smiling, my love. 💕",
  },
  {
    id: 2,
    name: "Sky Butterfly",
  ...
  },
  {
    ...
    title: "Every Little Laugh & Playful Moment",
    message:
      "We have our funny little moments, silly debates, and times when you get playful and pretend to be mad while I try everything just to make you laugh! Loving you through every single mood is my favorite thing in this world. 💖",
  },
  {
    id: 4,
    ...
    flapSpeed: "0.26s",
    scale: 1.2,
    tag: "My Heartfelt Wish ✨",
    title: "In Every Quiet Wish",
    message:
      "In every quiet moment and heartfelt wish, your happiness is always what I hope for most. I hope life blesses you with vibrant health, endless laughter, and all the boundless happiness your kind and gentle heart deserves. ✨❤️",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    title: "Liam Will Always Be Yours",
    message:
      "Times will change, seasons will turn, and years will fly by — but my love and devotion for you will only grow deeper with each passing day. You were, you are, and you will forever be my favorite person. Happy Birthday, Sophia! Always yours, Liam. ❤️",
  },
];
    ...
    <section id="butterflies" className="relative mx-auto max-w-6xl px-6 py-24">
      ...
      <div className="mb-10 text-center reveal" data-reveal>
        <h2 className="font-playfair font-semibold tracking-wide glow-soft text-gradient-romance text-3xl leading-tight sm:text-5xl">
          Flutters of Love for Sophia
        </h2>
        <p className="font-lora italic mx-auto mt-4 max-w-2xl text-sm sm:text-base text-muted-foreground">
          Every fluttering butterfly carries a sweet secret message from Liam... tap any butterfly to discover what his heart has to say! 🦋💕
        </p>
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-3 text-center text-xs font-medium text-muted-foreground/60 select-none">
          💕 Tap any floating butterfly to catch Liam's message 💕
        </div>
